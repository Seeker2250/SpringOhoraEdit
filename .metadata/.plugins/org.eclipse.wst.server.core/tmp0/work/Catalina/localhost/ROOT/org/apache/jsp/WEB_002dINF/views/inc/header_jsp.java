 ...
 * Generated at: 2024-11-28 14:21:22 UTC
...
public final class header_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("jar:file:/C:/JoonWorkspace/SpringOhora/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/ProjectOhora/WEB-INF/lib/jstl-1.2.jar!/META-INF/fn.tld", Long.valueOf(1153352682000L));
  }
...
boolean isLoggedIn = (session.getAttribute("userId") != null);
      ...
      if (_jspx_eval_c_005fchoose_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /WEB-INF/views/inc/header.jsp(186,13) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("		           // 카운트를 실제 상품 개수로 표시\r\n");
      out.write("		           const basketCookie = document.cookie\r\n");
      out.write("		               .split('; ')\r\n");
      out.write("		               .find(row => row.startsWith('basketItems='));\r\n");
      out.write("		           const items = basketCookie ? basketCookie.split('=')[1].split(',') : [];\r\n");
      out.write("		           countElement.textContent = items.length;\r\n");
      out.write("		       }\r\n");
      out.write("		   }\r\n");
      out.write("		};\r\n");
      out.write("</script>\r\n");
